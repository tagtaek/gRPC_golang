...
func (c *bidirectionalClient) GetServerResponse(ctx context.Context, opts ...grpc.CallOption) (Bidirectional_GetServerResponseClient, error) {
	stream, err := c.cc.NewStream(ctx, &Bidirectional_ServiceDesc.Streams[0], "/bidirectional_streaming.Bidirectional/GetServerResponse", opts...)
	if err != nil {
		return nil, err
	}
...
var Bidirectional_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bidirectional_streaming.Bidirectional",
